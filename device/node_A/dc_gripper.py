...
if __name__ == "__main__":
    ...
    fr_gripper = DCBottleGripper(FR_DIR_PIN, FR_EN_PIN)
    re_gripper = DCBottleGripper(RE_DIR_PIN, RE_EN_PIN)
    ...
    while True:
        ...
        if cmd == "g":
            ...
            re_gripper.hold_bottle(di, sensor_name="S13_rear_bottle_grip")

            # fr_gripper.hold_bottle(di, sensor_name="S11_front_bottle_grip")
            ...
            re_gripper.release_bottle(di, sensor_name="S14_rear_bottle_release")
            # fr_gripper.release_bottle(di, sensor_name="S12_front_bottle_release")
