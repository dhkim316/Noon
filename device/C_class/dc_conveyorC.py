...
if __name__ == "__main__":
    ...
    # EN_PIN  = 14    #Left Conv Sensor = S9
    EN_PIN  = 15    #Right Conv Sensor = S10
    ...
    while True:
        ...
        if cmd == "g":
            if not di:
                ...
                continue
            print("[CMD] Go")
            # conv.go(di, sensor_name="S9",timeout_ms=7000)
            conv.go(di, sensor_name="S10",timeout_ms=7000)
        elif cmd == "s":
            print("[CMD] STOP")
            conv.stop()
